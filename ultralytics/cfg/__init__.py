...
TASKS = frozenset({"detect", "segment", "classify", "pose", "obb", "segment_pose"})
TASK2DATA = {
    "detect": "coco8.yaml",
    ...
    "obb": "dota8.yaml",
    "segment_pose": "coco-segpose.yaml",
}
TASK2MODEL = {
    "detect": "yolo26n.pt",
    ...
    "obb": "yolo26n-obb.pt",
    "segment_pose": "yolov8n-segpose.yaml",
}
TASK2METRIC = {
    ...
    "segment_pose": "metrics/mAP50-95(M)",
}
