...
from ultralytics.nn.tasks import ClassificationModel, DetectionModel, SegmentPoseModel, SegmentationModel, WorldModel
...
class Exporter:
    ...
    def export_onnx(self, prefix=colorstr("ONNX:")):
        ...
        output_names = ["output0", "output1"] if self.model.task in {"segment", "segment_pose"} else ["output0"]
